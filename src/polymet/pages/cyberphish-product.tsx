...
export default function CyberPhishProduct() {
  ...
  const FEATURES = [
    ...
    },
    {
      ...
      url: "cyberphish.qswra.sa / simulations",
    ...
    },
    {
      ...
      url: "cyberphish.qswra.sa / leaderboard",
    ...
    },
    {
      ...
      url: "cyberphish.qswra.sa / analytics",
    ...
    },
    {
      ...
      url: "cyberphish.qswra.sa / groups",
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0B1117] transition-colors duration-200" dir={isRTL ? "rtl" : "ltr"}>
      ...
      {/* ── 1. HERO ── */}
      <section id="hero" className="relative overflow-hidden pt-24 pb-20 md:pt-32 md:pb-28 bg-white dark:bg-[#0B1117]">
        ...
        <div className="relative container mx-auto px-6 max-w-6xl">
          <div className="grid lg:grid-cols-[5fr_7fr] gap-10 lg:gap-14 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative">
                <Browser url="cyberphish.qswra.sa / dashboard" img={BASE + "hero-dashboard.png"} alt="CyberPhish dashboard" />
      ...
      <section id="features" className="py-24 md:py-32 bg-white dark:bg-[#0B1117]">
